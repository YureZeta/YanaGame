...
Este repositório tem uma implementação estática em HTML5, CSS3 e JavaScript para um jogo tipo "Ache o Wally" com uma UI adaptativa para mouse e touch screen.
